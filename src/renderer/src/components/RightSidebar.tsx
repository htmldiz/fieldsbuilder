...
function RightSidebar(): JSX.Element {
  ...
  return (
    <div className="fixed top-0 right-0 flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 h-[calc(100vh-.3rem)] w-full max-w-[20rem] p-4 shadow-xl shadow-blue-gray-900/5 animate-in slide-in-from-right">
